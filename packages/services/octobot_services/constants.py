...
CONFIG_LLM_CUSTOM_BASE_URL = "base-url"
CONFIG_LLM_MODEL = "model"
CONFIG_LLM_MODEL_FAST = "model-fast"
CONFIG_LLM_MODEL_REASONING = "model-reasoning"
CONFIG_LLM_DAILY_TOKENS_LIMIT = "daily-tokens-limit"
CONFIG_LLM_SHOW_REASONING = "show-reasoning"
CONFIG_LLM_REASONING_EFFORT = "reasoning-effort"
CONFIG_LLM_MCP_SERVERS = "mcp-servers"
CONFIG_LLM_AUTO_INJECT_MCP_TOOLS = "auto-inject-mcp-tools"
CONFIG_LLM_TOOL_CALL_JSON_OUTPUT = "tool-call-json-output"
CONFIG_LLM_AI_PROVIDER = "ai-provider"
CONFIG_LLM_AUTH_TOKEN = "auth-token"
ENV_OPENAI_SECRET_KEY = "OPENAI_SECRET_KEY"
ENV_GPT_MODEL = "GPT_MODEL"
ENV_GPT_DAILY_TOKENS_LIMIT = "GPT_DAILY_TOKEN_LIMIT"

# LangChain
CONFIG_LANGCHAIN = "langchain"
CONFIG_LANGCHAIN_AI_PROVIDER = "ai-provider"
CONFIG_LANGCHAIN_API_KEY = "api-key"
CONFIG_LANGCHAIN_CUSTOM_BASE_URL = "base-url"
CONFIG_LANGCHAIN_MODEL = "model"
CONFIG_LANGCHAIN_MODEL_FAST = "model-fast"
CONFIG_LANGCHAIN_MODEL_REASONING = "model-reasoning"
CONFIG_LANGCHAIN_DAILY_TOKENS_LIMIT = "daily-tokens-limit"
ENV_LANGCHAIN_API_KEY = "LANGCHAIN_API_KEY"
ENV_LANGCHAIN_MODEL = "LANGCHAIN_MODEL"
ENV_LANGCHAIN_DAILY_TOKENS_LIMIT = "LANGCHAIN_DAILY_TOKEN_LIMIT"
