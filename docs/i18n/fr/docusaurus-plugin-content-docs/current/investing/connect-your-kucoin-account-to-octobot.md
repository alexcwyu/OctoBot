...
<div style={{textAlign: "center"}}>
  ![creer api verification
  securite](/images/guides/kucoin/create-api-security-verification.png)
</div>
...
<div style={{textAlign: "center"}}>
  ![api cree key
  selectionnees](/images/guides/kucoin/api-creation-completed-selected-values.png)
</div>
...
<div style={{textAlign: "center"}}>
  *Ajouter une API Key au lancement d'une stratégie*
</div>

![ajouter api key a octobot cloud depuis profil](/images/guides/kucoin/add-api-key-to-octobot-cloud-from-profile.png)

<div style={{textAlign: "center"}}>
  *Ajouter une API Key depuis{' '}
  <a href="https://www.octobot.cloud/fr/account" rel="nofollow">votre profil</a>
  *
</div>
