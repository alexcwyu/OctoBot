...
The OctoBot web app is available on <a href="https://mobile.octobot.cloud" rel="nofollow">mobile.octobot.cloud</a>.

:::info
  It allows you to use the application without having to install it on your
  phone.
:::
